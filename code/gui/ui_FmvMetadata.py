...
" }")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/imgFMV/images/pdf.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/imgFMV/images/csv.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.Off)
