...
#
# Originally created by: PyQt5 UI code generator 5.10.1 -- manually migrated to Qt6/PyQt6 (see MIGRATION_QT6_PYQT6.md)
#
# NOTE: manually migrated for Qt6/PyQt6. Do not blindly regenerate from the .ui
# file - see MIGRATION_QT6_PYQT6.md (some .ui sources in this repo have drifted
# from the widget structure these files actually use, e.g. widget promotions).
# If you do regenerate, re-apply the fixes documented there.
...
class Ui_ManagerWindow(object):
    def setupUi(self, ManagerWindow):
        ...
        self.versionLabel.setText("v 1.17")
        ...
        self.VManager.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.DropOnly)
        ...
        self.VManager.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.VManager.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.VManager.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
...
" }\n"
"")
        self.VManager.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.VManager.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.VManager.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)                                                                               
        self.VManager.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.VManager.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.NoDragDrop)
        self.VManager.setAlternatingRowColors(True)
        self.VManager.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        self.VManager.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        self.VManager.setGridStyle(QtCore.Qt.PenStyle.SolidLine)
        ...
        self.actionOpen_MPEG2_File = QtGui.QAction(ManagerWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/imgFMV/images/misb-file.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionOpen_MPEG2_File.setIcon(icon2)
        self.actionOpen_MPEG2_File.setObjectName("actionOpen_MPEG2_File")
        self.actionCreate_MISB_File = QtGui.QAction(ManagerWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/imgFMV/images/multiplexer.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
