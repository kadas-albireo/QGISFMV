...
class Ui_PlayerWindow(object):
    def setupUi(self, PlayerWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/imgFMV/images/icon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
" } ")
        ...
        self.lb_prec_ts.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        self.btn_Color.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btn_Color.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/imgFMV/images/color_picker.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/imgFMV/images/record.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon2.addPixmap(QtGui.QPixmap(":/imgFMV/images/rec_on.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        ...
        #icon3 = QtGui.QIcon()
        #icon3.addPixmap(QtGui.QPixmap(":/imgFMV/images/mosaic.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/imgFMV/images/screenshot.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"                }")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/imgFMV/images/skip-previous.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/imgFMV/images/fast-rewind.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/imgFMV/images/stop.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/imgFMV/images/play-arrow.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/imgFMV/images/fast-forward.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/imgFMV/images/skip-next.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/imgFMV/images/repeat.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/imgFMV/images/volume_up.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        self.DrawToolBar.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.PreventContextMenu)
        self.DrawToolBar.setObjectName("DrawToolBar")
        PlayerWindow.addToolBar(QtCore.Qt.ToolBarArea.TopToolBarArea, self.DrawToolBar)
        self.actionGray = QtGui.QAction(PlayerWindow)
        self.actionGray.setCheckable(True)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/imgFMV/images/grayscale.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionGray.setIcon(icon13)
        self.actionGray.setObjectName("actionGray")
        self.actionEdge_Detection = QtGui.QAction(PlayerWindow)
        self.actionEdge_Detection.setCheckable(True)
        self.actionEdge_Detection.setObjectName("actionEdge_Detection")
        self.actionCapture_Current_Frame = QtGui.QAction(PlayerWindow)
        ...
        #self.actionExtract_All_Frames = QtGui.QAction(PlayerWindow)
        #icon14 = QtGui.QIcon()
        #icon14.addPixmap(QtGui.QPixmap(":/imgFMV/images/capture_all_frames.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.actionShow_Metadata = QtGui.QAction(PlayerWindow)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/imgFMV/images/show-metadata.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.actionConverter_Video = QtGui.QAction(PlayerWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/imgFMV/images/video-converter.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionConverter_Video.setIcon(icon16)
        self.actionConverter_Video.setObjectName("actionConverter_Video")
        self.actionSave_Video_Info = QtGui.QAction(PlayerWindow)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/imgFMV/images/save-video-info.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSave_Video_Info.setIcon(icon17)
        self.actionSave_Video_Info.setObjectName("actionSave_Video_Info")
        self.actionAudio = QtGui.QAction(PlayerWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/imgFMV/images/show-bitrate.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionAudio.setIcon(icon18)
        self.actionAudio.setObjectName("actionAudio")
        self.actionVideo = QtGui.QAction(PlayerWindow)
        self.actionVideo.setIcon(icon18)
        self.actionVideo.setObjectName("actionVideo")
        self.actionAudio_Video = QtGui.QAction(PlayerWindow)
        self.actionAudio_Video.setObjectName("actionAudio_Video")
        self.actionSave_Audio = QtGui.QAction(PlayerWindow)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/imgFMV/images/save-bitrate.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSave_Audio.setIcon(icon19)
        self.actionSave_Audio.setObjectName("actionSave_Audio")
        self.actionSave_Video = QtGui.QAction(PlayerWindow)
        self.actionSave_Video.setIcon(icon19)
        self.actionSave_Video.setObjectName("actionSave_Video")
        self.actionSave_All = QtGui.QAction(PlayerWindow)
        self.actionSave_All.setObjectName("actionSave_All")
        self.actionShow_Video_Info = QtGui.QAction(PlayerWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/imgFMV/images/video-info.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionShow_Video_Info.setIcon(icon20)
        self.actionShow_Video_Info.setObjectName("actionShow_Video_Info")
        self.actionInvert_Color = QtGui.QAction(PlayerWindow)
        self.actionInvert_Color.setCheckable(True)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/imgFMV/images/invert-colors.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionInvert_Color.setIcon(icon21)
        self.actionInvert_Color.setObjectName("actionInvert_Color")
        self.actionMono_Filter = QtGui.QAction(PlayerWindow)
        self.actionMono_Filter.setCheckable(True)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/imgFMV/images/mono.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionMono_Filter.setIcon(icon22)
        self.actionMono_Filter.setObjectName("actionMono_Filter")
        self.actionCanny_edge_detection = QtGui.QAction(PlayerWindow)
        self.actionCanny_edge_detection.setCheckable(True)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/imgFMV/images/canny.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionCanny_edge_detection.setIcon(icon23)
        self.actionCanny_edge_detection.setObjectName("actionCanny_edge_detection")
        self.actionZoom_Rectangle = QtGui.QAction(PlayerWindow)
        ...
        self.actionMagnifying_glass = QtGui.QAction(PlayerWindow)
        self.actionMagnifying_glass.setCheckable(True)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/imgFMV/images/magnifier-glass.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionMagnifying_glass.setIcon(icon24)
        self.actionMagnifying_glass.setObjectName("actionMagnifying_glass")
        self.actionAuto_Contrast_Filter = QtGui.QAction(PlayerWindow)
        self.actionAuto_Contrast_Filter.setCheckable(True)
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/imgFMV/images/automatic-contrast.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionAuto_Contrast_Filter.setIcon(icon25)
        self.actionAuto_Contrast_Filter.setObjectName("actionAuto_Contrast_Filter")
        #self.actionCreate_Mosaic = QtGui.QAction(PlayerWindow)
        #self.actionCreate_Mosaic.setIcon(icon3)
        #self.actionCreate_Mosaic.setObjectName("actionCreate_Mosaic")
        self.actionDraw_Pinpoint = QtGui.QAction(PlayerWindow)
        self.actionDraw_Pinpoint.setCheckable(True)
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-point.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionDraw_Pinpoint.setIcon(icon26)
        self.actionDraw_Pinpoint.setObjectName("actionDraw_Pinpoint")
        self.actionDraw_Line = QtGui.QAction(PlayerWindow)
        self.actionDraw_Line.setCheckable(True)
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polyline.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionDraw_Line.setIcon(icon27)
        self.actionDraw_Line.setObjectName("actionDraw_Line")
        self.actionDraw_Polygon = QtGui.QAction(PlayerWindow)
        self.actionDraw_Polygon.setCheckable(True)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polygon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionDraw_Polygon.setIcon(icon28)
        self.actionDraw_Polygon.setObjectName("actionDraw_Polygon")
        self.actionObject_Tracking = QtGui.QAction(PlayerWindow)
        self.actionObject_Tracking.setCheckable(True)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/imgFMV/images/object-tracking.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionObject_Tracking.setIcon(icon29)
        self.actionObject_Tracking.setObjectName("actionObject_Tracking")
        self.actionStamp = QtGui.QAction(PlayerWindow)
        self.actionStamp.setCheckable(True)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/imgFMV/images/rubber-stamp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionStamp.setIcon(icon30)
        self.actionStamp.setObjectName("actionStamp")
        self.actionMeasureDistance = QtGui.QAction(PlayerWindow)
        self.actionMeasureDistance.setCheckable(True)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/imgFMV/images/ruler.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionMeasureDistance.setIcon(icon31)
        self.actionMeasureDistance.setObjectName("actionMeasureDistance")
        self.actionMeasureArea = QtGui.QAction(PlayerWindow)
        self.actionMeasureArea.setCheckable(True)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/imgFMV/images/ruler_surface.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionMeasureArea.setIcon(icon32)
        self.actionMeasureArea.setObjectName("actionMeasureArea")
        self.actionHandDraw = QtGui.QAction(PlayerWindow)
        self.actionHandDraw.setCheckable(True)
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/imgFMV/images/HandDraw.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionHandDraw.setIcon(icon33)
        self.actionHandDraw.setObjectName("actionHandDraw")
        self.actionMirroredH = QtGui.QAction(PlayerWindow)
        self.actionMirroredH.setCheckable(True)
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/imgFMV/images/mirrored.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionMirroredH.setIcon(icon34)
        self.actionMirroredH.setObjectName("actionMirroredH")
        self.actionCensure = QtGui.QAction(PlayerWindow)
        self.actionCensure.setCheckable(True)
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/imgFMV/images/censure-pencil.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionCensure.setIcon(icon35)
        self.actionCensure.setObjectName("actionCensure")
        self.actionRemove_Last_censured = QtGui.QAction(PlayerWindow)
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/imgFMV/images/censure-pencil-remove-last.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionRemove_Last_censured.setIcon(icon36)
        self.actionRemove_Last_censured.setObjectName("actionRemove_Last_censured")
        self.actionRemove_All_censured = QtGui.QAction(PlayerWindow)
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/imgFMV/images/censure-pencil-remove-all.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionRemove_All_censured.setIcon(icon37)
        self.actionRemove_All_censured.setObjectName("actionRemove_All_censured")
        self.actionDraw_Polygon_remove_last = QtGui.QAction(PlayerWindow)
        self.actionDraw_Polygon_remove_last.setCheckable(False)
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polygon-remove-last.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.actionDraw_Polygon_remove_all = QtGui.QAction(PlayerWindow)
        self.actionDraw_Polygon_remove_all.setCheckable(False)
        icon39 = QtGui.QIcon()
        icon39.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polygon-remove-all.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.actionRemove_Last_Pinpoint = QtGui.QAction(PlayerWindow)
        self.actionRemove_Last_Pinpoint.setCheckable(False)
        icon40 = QtGui.QIcon()
        icon40.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-point-remove-last.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionRemove_Last_Pinpoint.setIcon(icon40)
        self.actionRemove_Last_Pinpoint.setObjectName("actionRemove_Last_Pinpoint")
        self.actionRemove_All_Pinpoint = QtGui.QAction(PlayerWindow)
        self.actionRemove_All_Pinpoint.setCheckable(False)
        icon41 = QtGui.QIcon()
        icon41.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-point-remove-all.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionRemove_All_Pinpoint.setIcon(icon41)
        self.actionRemove_All_Pinpoint.setObjectName("actionRemove_All_Pinpoint")
        self.actionRemove_All_Line = QtGui.QAction(PlayerWindow)
        self.actionRemove_All_Line.setCheckable(False)
        icon42 = QtGui.QIcon()
        icon42.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polyline-remove-all.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionRemove_All_Line.setIcon(icon42)
        self.actionRemove_All_Line.setObjectName("actionRemove_All_Line")
        self.actionLast_Segment_Line = QtGui.QAction(PlayerWindow)
        self.actionLast_Segment_Line.setCheckable(False)
        icon43 = QtGui.QIcon()
        icon43.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polyline-remove-last-segment.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionLast_Segment_Line.setIcon(icon43)
        self.actionLast_Segment_Line.setObjectName("actionLast_Segment_Line")
        self.actionRemove_Last_Line = QtGui.QAction(PlayerWindow)
        self.actionRemove_Last_Line.setCheckable(False)
        icon44 = QtGui.QIcon()
        icon44.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polyline-remove-last.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionRemove_Last_Line.setIcon(icon44)
        self.actionRemove_Last_Line.setObjectName("actionRemove_Last_Line")
        self.actionCenter_on_Platform = QtGui.QAction(PlayerWindow)
        self.actionCenter_on_Platform.setCheckable(True)
        icon45 = QtGui.QIcon()
        icon45.addPixmap(QtGui.QPixmap(":/imgFMV/images/center_platform.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionCenter_on_Platform.setIcon(icon45)
        self.actionCenter_on_Platform.setObjectName("actionCenter_on_Platform")
        self.actionCenter_on_Footprint = QtGui.QAction(PlayerWindow)
        self.actionCenter_on_Footprint.setCheckable(True)
        icon46 = QtGui.QIcon()
        icon46.addPixmap(QtGui.QPixmap(":/imgFMV/images/center_footprint.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionCenter_on_Footprint.setIcon(icon46)
        self.actionCenter_on_Footprint.setObjectName("actionCenter_on_Footprint")
        self.actionCenter_Target = QtGui.QAction(PlayerWindow)
        self.actionCenter_Target.setCheckable(True)
        icon47 = QtGui.QIcon()
        icon47.addPixmap(QtGui.QPixmap(":/imgFMV/images/center_target.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionCenter_Target.setIcon(icon47)
        self.actionCenter_Target.setObjectName("actionCenter_Target")
        self.actionNDVI = QtGui.QAction(PlayerWindow)
        self.actionNDVI.setCheckable(True)
        icon48 = QtGui.QIcon()
        icon48.addPixmap(QtGui.QPixmap(":/imgFMV/images/ndvi.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        #self.actionNDVI.setIcon(icon48)
        self.actionNDVI.setObjectName("actionNDVI")
        self.actionCapture_Georeferenced_Frame = QtGui.QAction(PlayerWindow)
        icon49 = QtGui.QIcon()
        icon49.addPixmap(QtGui.QPixmap(":/imgFMV/images/save_geoframe.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
